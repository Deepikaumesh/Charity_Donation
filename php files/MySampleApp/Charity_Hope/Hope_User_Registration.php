...
$findexist="select * from  hope_user_registration where username='".$username."'";
    ...
    $sql = "INSERT INTO  hope_user_registration (username,email,phone,password) VALUES ('".$username."','".$email."','".$phone."','".$password."')";
