...
$findexist="select * from hope_admin_registration where username='".$username."'";
    ...
    $sql = "INSERT INTO hope_admin_registration (username,email,phone,password) VALUES ('".$username."','".$email."','".$phone."','".$password."')";
