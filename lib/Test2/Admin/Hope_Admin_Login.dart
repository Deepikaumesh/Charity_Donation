...
import 'Hope_Admin_Registration.dart';
...
class _Hope_Admin_LoginState extends State<Hope_Admin_Login> {
  TextEditingController hope_Admin_user = TextEditingController();
  TextEditingController Hope_Admin_pass = TextEditingController();
                                  ...
                                  child: IconButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        if (Merchant_formkey.currentState!.validate()) {
                                          ...
                                          hope_Admin_user.clear();
                                          Hope_Admin_pass.clear();
                                        }
                                      }),
                                ),
                              ],
                              ...
                              children: [
                                TextButton(
                                  onPressed: () {
                                    ...
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>Hope_Admin_Registration()));
                                  },
                                  child: Text(
...
Future Merchant_Login() async {
  ...
  var response = await http.post(Uri.parse(url), body: {
    "username": hope_Admin_user.text,
    "password": Hope_Admin_pass.text,
  });
