...
class User_food_donation_bookings_view_more extends StatefulWidget {
  @override
  _User_food_donation_bookings_view_moreState createState() => _User_food_donation_bookings_view_moreState();
}

class _User_food_donation_bookings_view_moreState extends State<User_food_donation_bookings_view_more> {
                                                  ...
                                                  IconButton(onPressed: (){
                                                    Navigator.pushReplacement(context,
                                                        MaterialPageRoute(builder: (context)=>
                                                            View_User_food_donation_Detail_Page(data_food_donation:snapshot.data[index])));
