...
import '../User/Display_donations_User_.dart';


class View_User_Donation_Detail_Page extends StatefulWidget {
  final donation_model donation_data;

  const View_User_Donation_Detail_Page({required this.donation_data});

  @override
  _View_User_Donation_Detail_PageState createState() =>
      _View_User_Donation_Detail_PageState();
}

class _View_User_Donation_Detail_PageState extends State<View_User_Donation_Detail_Page> {
  @override
